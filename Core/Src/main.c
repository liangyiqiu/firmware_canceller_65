...
/* USER CODE BEGIN 4 */
/**
  * @brief SIC Initialization Function
  * @param None
  * @retval None
  */
static void sic_init(void)
{
  ...
  htap[0].att_dac_handle=&hdac3;
  htap[0].att_dac_channel=DAC_CHANNEL_1;
  htap[0].att_slope=1;
  htap[0].att_data=0;
  htap[0].ps_dac_spi_handle=&hspi3;
  htap[0].ps_dac_channel=0;
  htap[0].ps_data=0;

  if(htap[0].att_slope==1)
  ...
  htap[1].att_dac_handle=&hdac4;
  htap[1].att_dac_channel=DAC_CHANNEL_1;
  htap[1].att_slope=1;
  htap[1].att_data=0;
  htap[1].ps_dac_spi_handle=&hspi3;
  htap[1].ps_dac_channel=1;
  htap[1].ps_data=0;

  if(htap[1].att_slope==1)
  ...
  htap[2].att_dac_handle=&hdac4;
  htap[2].att_dac_channel=DAC_CHANNEL_2;
  htap[2].att_slope=1;
  htap[2].att_data=0;
  htap[2].ps_dac_spi_handle=&hspi3;
  htap[2].ps_dac_channel=2;
  htap[2].ps_data=0;

  if(htap[2].att_slope==1)
  ...
  htap[3].att_dac_handle=&hdac3;
  htap[3].att_dac_channel=DAC_CHANNEL_2;
  htap[3].att_slope=1;
  htap[3].att_data=0;
  htap[3].ps_dac_spi_handle=&hspi3;
  htap[3].ps_dac_channel=3;
  htap[3].ps_data=0;

  if(htap[3].att_slope==1)
  ...
  htap[4].att_dac_handle=&hdac1;
  htap[4].att_dac_channel=DAC_CHANNEL_2;
  htap[4].att_slope=1;
  htap[4].att_data=0;
  htap[4].ps_dac_spi_handle=&hspi3;
  htap[4].ps_dac_channel=4;
  htap[4].ps_data=0;

  if(htap[4].att_slope==1)
